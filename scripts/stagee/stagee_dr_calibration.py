...
STAGEE_DR_CALIBRATOR_MODEL_FORMAT = "stagee_dr_calibrator_v1"
STAGEE_DR_CALIBRATOR_MODEL_ID = "stagee_dr_calibrator_ridge_v1"
...
def load_stagee_dr_calibrator_model(model_path: str | Path) -> dict[str, Any]:
    ...
    if payload.get("model_format") != STAGEE_DR_CALIBRATOR_MODEL_FORMAT:
        raise ValueError(
...
def predict_stagee_dr_calibrator(
    ...
    *,
    ...
    return {
        "model_id": str(model.get("model_id") or STAGEE_DR_CALIBRATOR_MODEL_ID),
